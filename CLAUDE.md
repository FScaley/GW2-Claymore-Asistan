...
- **FC diagnostics:** Every tool call is logged as `FC name args -> (NB, Tms) result_preview` (N = result byte size, T = wall time, preview 120 chars). Stripped fake chatlinks are logged as `Stripped fake chatlink: [&...]`.
